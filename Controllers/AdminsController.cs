...
namespace PicPerfect.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Username,Password,Email,Role")] Admins admins)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Username,Password,Email,Role")] Admins admins)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!AdminsExists(admins.Username))
                    {
                        return NotFound();
                    }
                    else
